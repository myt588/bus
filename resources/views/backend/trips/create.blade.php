...
@section('breadcrumb')
    ...
    <li><a href="/admin/trips/create">Create</a></li>
...
<div class="box box-primary"> 
    {!! Form::open(['url' => 'admin/trips', 'class' => 'form-horizontal']) !!}
            ...
            <div class="col-md-6">
                <div class="dynamic" id="departure">
                    ...
                    <div class="form-group {{ $errors->has('depart_stops') ? 'has-error' : ''}}" id="d_template">
                        ...
                        <div class="col-sm-3">
                            {!! Form::select('depart_stops[]', $stations, null, ['class' => 'form-control']) !!}
                        </div>
                        <div class="col-sm-3 bootstrap-timepicker">
                            {!! Form::text('depart_times[]', null, ['class' => 'form-control timepicker']) !!}
                        </div>
                        <div class="col-sm-1">
                            <button type="button" class="btn btn-default removeButton hidden"><i class="fa fa-minus"></i></button>
                        </div>
                    </div>
                </div>
                <div class="dynamic" id="arrive">
                    ...
                    <div class="form-group {{ $errors->has('arrive_stops') ? 'has-error' : ''}}" id="a_template">
                        <label class="col-sm-3 control-label">Station:</label>
                        <div class="col-sm-3">
                            {!! Form::select('arrive_stops[]', $stations, null, ['class' => 'form-control']) !!}
                        </div>
                        <div class="col-sm-3 bootstrap-timepicker">
                            {!! Form::text('arrive_times[]', null, ['class' => 'form-control timepicker']) !!}
                        </div>
                        <div class="col-sm-1">
                            <button type="button" class="btn btn-default removeButton hidden"><i class="fa fa-minus"></i></button>
                        </div>
